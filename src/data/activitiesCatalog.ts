...
export const ACTIVITY_FIELDS: ActivityField[] = [
  {
    ...
    label: "Lager, Transport & Logistik",
    icon: "📦",
    kldb_hauptgruppen: ["51", "52"],
    activities: [
      // Rollen-Erweiterung 24.09.2026: auf die neuen Logistik-Skills gemappt
      // (vorher nur generische Handels-/Planungs-Skills).
      { activity_id: "lager-wareneingang", label: "Waren annehmen, prüfen und einlagern", skills: [d("wareneingangskontrolle"), t("lagerorganisation"), t("bestandsmanagement")] },
      { activity_id: "lager-inventur", label: "Bestände zählen und Inventur machen", skills: [d("inventur"), d("bestandsmanagement")] },
      { activity_id: "lager-system-buchen", label: "Warenbewegungen im System oder per Scanner buchen (z. B. SAP)", skills: [d("lagerverwaltungssysteme"), d("warenwirtschaftssysteme"), t("erp-systeme")] },
      { activity_id: "lager-kommissionieren", label: "Aufträge zusammenstellen (kommissionieren)", skills: [d("kommissionierung")] },
      { activity_id: "lager-versand", label: "Ware verpacken und Versand vorbereiten", skills: [d("warenausgang-versand"), d("verpackung-transportschutz"), t("frachtdokumente")] },
      { activity_id: "lager-stapler", label: "Gabelstapler oder Hubwagen fahren", skills: [d("flurfoerderzeuge-staplerschein")] },
      { activity_id: "lager-ladung", label: "Lkw be- und entladen und Ladung sichern", skills: [d("ladungssicherung"), t("verpackung-transportschutz")] },
      ...
      { activity_id: "lager-touren", label: "Liefertouren oder Liefertermine planen", skills: [d("tourenplanung"), t("logistikplanung"), t("terminplanung")] },
      { activity_id: "lager-nachbestellen", label: "Material nachbestellen und Lieferanten ansprechen", skills: [d("materialwirtschaft"), t("lieferantenmanagement"), t("bedarfsplanung-disposition")] },
      { activity_id: "lager-ausliefern", label: "Ware oder Pakete ausliefern", skills: [d("zustellung-kundenkontakt"), t("tourenplanung"), t("ladungssicherung")] },
      { activity_id: "lager-lkw", label: "Lkw fahren (Führerschein C/CE)", skills: [d("berufskraftfahrer-qualifikation"), t("lenk-und-ruhezeiten"), t("fahrzeugpflege-abfahrtkontrolle")] },
      { activity_id: "lager-disposition", label: "Fahrzeuge und Fahrer einteilen (Disposition)", skills: [d("disposition-fuhrpark"), t("telematik-transportmanagementsysteme")] },
      { activity_id: "lager-spedition", label: "Transporte bei einer Spedition organisieren oder Frachtpapiere erstellen", skills: [d("speditionsabwicklung"), d("frachtdokumente"), t("frachtkalkulation")] },
    ],
  },
  {
    ...
    activities: [
      { activity_id: "verkauf-beraten", label: "Kundinnen und Kunden beraten", skills: [d("kundenberatung"), t("produktberatung"), t("verkaufsgespraechsfuehrung")] },
      { activity_id: "verkauf-kasse", label: "Kassieren und die Kasse abrechnen", skills: [d("kassensysteme"), d("kassenabrechnung"), t("kartenzahlung-zahlungsmittel"), t("kassenbuchfuehrung")] },
      { activity_id: "verkauf-regale", label: "Regale auffüllen und Haltbarkeitsdaten kontrollieren", skills: [d("regalpflege-mhd"), t("wareneingangskontrolle")] },
      { activity_id: "verkauf-praesentieren", label: "Ware einräumen und ansprechend präsentieren", skills: [d("warenpraesentation"), t("visual-merchandising"), t("verkaufsfoerderung")] },
      ...
      { activity_id: "verkauf-angebote", label: "Angebote schreiben und bei Kunden nachfassen", skills: [d("vertriebsunterstuetzung"), d("angebots-auftragsbearbeitung"), t("angebotskalkulation")] },
      { activity_id: "verkauf-aussendienst", label: "Kunden vor Ort besuchen oder neue Kunden gewinnen", skills: [d("aussendienst-kundenbesuche"), t("neukundenakquise"), t("verkaufsgespraechsfuehrung")] },
      { activity_id: "verkauf-telefon", label: "Kundenanfragen am Telefon oder per E-Mail bearbeiten", skills: [d("kundenkommunikation"), t("angebots-auftragsbearbeitung")] },
    ],
  },
  {
    ...
    activities: [
      ...
      { activity_id: "buero-post-telefon", label: "Post bearbeiten und Anrufe annehmen", skills: [d("posteingang-ausgang"), d("telefonzentrale-empfang")] },
      ...
      { activity_id: "buero-antraege", label: "Anträge oder Vorgänge in einer Behörde bearbeiten", skills: [d("vorgangsbearbeitung-verwaltung"), t("buergerkommunikation"), t("verwaltungsrecht")] },
      { activity_id: "buero-lohn", label: "Löhne und Gehälter abrechnen", skills: [d("lohnbuchhaltung"), t("sozialversicherungsrecht"), t("lohnsteuerrecht")] },
    ],
  },
  {
    ...
    activities: [
      { activity_id: "prod-maschinen", label: "Maschinen oder Anlagen in der Produktion bedienen", skills: [d("maschinenbedienung"), t("anlagenueberwachung")] },
      { activity_id: "prod-ruesten", label: "Maschinen für neue Aufträge einrichten oder umrüsten", skills: [d("maschinen-einrichten-ruesten")] },
      { activity_id: "prod-fliessband", label: "Am Band oder in der Montage mitarbeiten", skills: [d("montagearbeiten")] },
      { activity_id: "prod-cnc", label: "CNC-Maschinen einrichten und bedienen", skills: [d("cnc-bedienung"), t("drehen-fraesen")] },
      { activity_id: "prod-pruefen", label: "Teile prüfen, messen und Fehler melden", skills: [d("qualitaetskontrolle"), d("mess-und-pruefmittel"), t("messtechnik-mechanik")] },
      ...
      { activity_id: "prod-sicherheit", label: "Auf Arbeitssicherheit achten und Kollegen unterweisen", skills: [d("arbeitsschutz-unterweisung"), t("sicherheitsvorschriften")] },
      { activity_id: "prod-schicht", label: "Im Schichtbetrieb arbeiten und Schichten übergeben", skills: [d("schichtuebergabe")] },
    ],
  },
  {
  ...
  },
  {
    ...
    activities: [
      ...
      { activity_id: "pflege-betreuung", label: "Ältere Menschen betreuen und beschäftigen (auch mit Demenz)", skills: [d("betreuung-aktivierung-senioren"), t("demenzbegleitung")] },
  ...
  },
  {
    ...
    activities: [
      { activity_id: "it-support", label: "Computer einrichten und Kollegen bei IT-Problemen helfen", skills: [d("it-support-helpdesk"), d("hardware-einrichtung"), t("betriebssystem-konfiguration")] },
  ...
  },
  {
    ...
    activities: [
      { activity_id: "gastro-gaeste", label: "Gäste bedienen und beraten", skills: [d("gaesteservice"), t("kundenberatung"), t("kundenkommunikation")] },
      { activity_id: "gastro-kasse", label: "Abrechnen und kassieren", skills: [d("kassensysteme"), t("kassenabrechnung")] },
      { activity_id: "gastro-bar", label: "Getränke zubereiten oder an der Bar arbeiten", skills: [d("getraenkekunde-bar")] },
      { activity_id: "gastro-kochen", label: "Kochen oder Speisen zubereiten", skills: [d("speisenzubereitung"), t("kuechenvorbereitung-mise-en-place")] },
      { activity_id: "gastro-vorbereiten", label: "In der Küche vorbereiten, schneiden und spülen", skills: [d("kuechenvorbereitung-mise-en-place")] },
      ...
      { activity_id: "gastro-hygiene", label: "Hygiene- und Sauberkeitsregeln für Lebensmittel umsetzen", skills: [d("lebensmittelhygiene-haccp"), d("hygienemassnahmen")] },
      { activity_id: "gastro-einkauf", label: "Waren bestellen und das Lager führen", skills: [d("warenannahme-lagerung-lebensmittel"), t("bestandsmanagement"), t("materialwirtschaft")] },
      { activity_id: "gastro-reservierung", label: "Reservierungen und Empfang übernehmen", skills: [d("reservierung-empfang"), t("hotelsoftware-pms"), t("kundenkommunikation")] },
      { activity_id: "gastro-zimmer", label: "Hotelzimmer reinigen und herrichten", skills: [d("housekeeping"), t("reinigungstechniken")] },
      { activity_id: "gastro-feiern", label: "Feiern, Bankette oder Catering betreuen", skills: [d("veranstaltungsgastronomie"), t("gaesteservice")] },
      { activity_id: "gastro-schichten", label: "Schichten einteilen", skills: [d("dienstplanung")] },
    ],
  },
  {
    // Rollen-Erweiterung 24.09.2026: eigenes Herkunftsfeld fuer die neuen
    // Dienstleistungsberufe (Sicherheit, Reinigung, Hausmeister) — typische
    // Herkunft bei Arbeitsagentur- und Transfer-Kundschaft.
    field_key: "sicherheit-gebaeude",
    label: "Sicherheit, Reinigung & Hausmeister",
    icon: "🛡️",
    kldb_hauptgruppen: ["53", "54"],
    activities: [
      { activity_id: "sich-bewachen", label: "Gebäude, Gelände oder Veranstaltungen bewachen", skills: [d("objekt-und-werkschutz"), t("bewachung-34a")] },
      { activity_id: "sich-einlass", label: "Einlass oder Empfang kontrollieren", skills: [d("zugangskontrolle-empfangsdienst"), t("deeskalationstechniken")] },
      { activity_id: "sich-34a", label: "Sachkundeprüfung nach § 34a bestanden", skills: [d("bewachung-34a")] },
      { activity_id: "sich-brandschutz", label: "Als Brandschutz- oder Ersthelfer eingesetzt", skills: [d("brandschutz-evakuierung"), t("erste-hilfe")] },
      { activity_id: "rein-reinigen", label: "Büros, Praxen oder Gebäude reinigen", skills: [d("reinigungstechniken"), t("desinfektion-hygiene-reinigung")] },
      { activity_id: "rein-maschinen", label: "Mit Reinigungsmaschinen arbeiten", skills: [d("reinigungsmaschinen")] },
      { activity_id: "haus-reparaturen", label: "Kleinere Reparaturen im Haus erledigen", skills: [d("haustechnik-kleinreparaturen"), t("wartung-und-inspektion")] },
      { activity_id: "haus-aussen", label: "Grünanlagen pflegen oder Winterdienst machen", skills: [d("gruenpflege-winterdienst")] },
    ],
  },
  {
